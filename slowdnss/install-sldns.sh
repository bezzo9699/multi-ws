...
wget -qO- -O /etc/ssh/sshd_config https://raw.githubusercontent.com/bezzo9699/multi-ws/main/slowdnss/sshd_config
...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/bezzo9699/multi-ws/main/slowdnss/sldns-server"
wget -qc -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/bezzo9699/multi-ws/main/slowdnss/sldns-client"
sleep 1
...
echo -e "[ ${green}INFO${NC} ] Successfully... "
sleep 1
#wget -q -O /etc/systemd/system/client-sldns.service "https://raw.githubusercontent.com/bezzo9699/multi-ws/main/slowdnss/client-sldns.service"
#wget -q -O /etc/systemd/system/server-sldns.service "https://raw.githubusercontent.com/bezzo9699/multi-ws/main/slowdnss/server-sldns.service"
cd
sleep 1
